...
import dev.patika.library_rest_api.dto.request.publisher.PublisherSaveRequest;
import dev.patika.library_rest_api.dto.request.publisher.PublisherUpdateRequest;
import dev.patika.library_rest_api.dto.response.CursorResponse;
import dev.patika.library_rest_api.dto.response.publisher.PublisherResponse;
...
public class PublisherController {
    ...
    public ResultData<CursorResponse<PublisherResponse>> cursor(
        ...
        cursor.setTotalElements(publisherResponsePage.getTotalElements());
